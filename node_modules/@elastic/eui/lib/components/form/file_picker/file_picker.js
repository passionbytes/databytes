    ...
    value: function render() {
      ...
      return _react.default.createElement(_i18n.EuiI18n, {
        ...
        var _this2$props = _this2.props,
            ...
            rest = _objectWithoutProperties(_this2$props, ["id", "name", "initialPromptText", "className", "disabled", "compressed", "onChange"]);
        ...
        var classes = (0, _classnames.default)('euiFilePicker', {
          ...
          'euiFilePicker-hasFiles': _this2.state.promptText !== initialPromptText
        }, className);
        var clearButton;

        if (_this2.state.promptText !== initialPromptText) {
          if (compressed) {
        ...
        }, _this2.state.promptText), clearButton)));
      });
    }
  }]);
