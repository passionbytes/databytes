...
import { EuiForm, EuiFormRow, EuiSelect, EuiFieldNumber, EuiFieldText, EuiSwitch } from '../../../form';
...
function (_Component) {
  ...
  _createClass(EuiRelativeTab, [{
    ...
    value: function render() {
      ...
      })))), React.createElement(EuiFormRow, null, React.createElement(EuiFieldText, {
        value: formatedValue,
        readOnly: true
      })), React.createElement(EuiFormRow, null, React.createElement(EuiSwitch, {
