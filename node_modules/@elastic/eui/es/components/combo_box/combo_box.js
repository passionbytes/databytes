  ...
  function EuiComboBox(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addCustomOption", function () {
      ...
      if (_this.doesSearchMatchOnlyOption()) {
        _this.onAddOption(matchingOptions[0]);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onComboBoxBlur", function () {
      _this.setState({
        hasFocus: false
      });
    });
  ...
  _createClass(EuiComboBox, [{
    ...
    value: function render() {
      var _this$props7 = this.props,
          ...
          onCreateOption = _this$props7.onCreateOption,
          placeholder = _this$props7.placeholder,
          noSuggestions = _this$props7.noSuggestions,
          renderOption = _this$props7.renderOption,
          singleSelection = _this$props7.singleSelection,
          onChange = _this$props7.onChange,
          onSearchChange = _this$props7.onSearchChange,
          ...
          rest = _objectWithoutProperties(_this$props7, ["id", "isDisabled", "className", "isLoading", "options", "selectedOptions", "onCreateOption", "placeholder", "noSuggestions", "renderOption", "singleSelection", "onChange", "onSearchChange", "async", "onBlur", "isInvalid", "rowHeight", "isClearable", "fullWidth", "compressed", "data-test-subj"]);
      ...
      var markAsInvalid = isInvalid || hasFocus === false && searchValue;
